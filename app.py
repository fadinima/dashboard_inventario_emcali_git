...
for carpeta in ["uploads", "uploads_temp", "clean_data"]:
...
def procesar(headers, rows, cols, hoja_nombre, nombre_archivo=''):
    ...
    for r in rows:
        ...
        refs  = sf(r.get(cols.get("referencias") or "_"))
...
<th style="background:#003B7A;color:white;padding:10px 14px;text-align:right;position:sticky;top:0;font-size:11px;text-transform:uppercase">Referencias</th>
